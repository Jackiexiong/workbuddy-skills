...
WorkBuddy（CodeBuddy）技能集合，分场景型与角色型两大类，支持按需远程安装。
...
| `custom/` | 场景 | 追求效率的用户 | 自我排查框架、需求文档撰写、周报生成 |
...
| 子分类 | 目标用户 | 技能 |
|--------|----------|------|
| `roles/coding/` | 程序员 | GitHub 管理、代码交叉审查、全栈开发、本地笔记搜索 |
| `roles/design/` | 前端开发者 | 生产级前端界面设计、避免 AI 通用风格 |
| `roles/ai-creation/` | AI 创作者 | AI 图片生成、语音转文字、视频下载、AI 资讯、旅行规划 |
| `roles/teacher/` | 教师用户 | 备课助手、试卷生成、学生成绩分析、课设报告评分 |
| `roles/hr/` | 人力资源 | 简历筛选、考勤统计 |
...
`teaching-preparation-assistant` `exam-paper-generator` `grade-analysis` `course-report-grading`
